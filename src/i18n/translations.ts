...
export const UI_TRANSLATIONS = {
  ja: {
    ...
    footer: {
      ...
      sitemapTitle: "サイトマップ",
      copyrightTitle: "著作権・権利表記",
      copyrightText: "当サイトで使用しているアニメの画像、ロゴ、作品名、キャラクター等の著作権および商標権その他の知的財産権は、すべて各権利所有者・制作会社に帰属します。",
      ...
      disclaimer: "【免責事項】当サイトは個人またはAIによる情報提供およびアニメ紹介を目的とした情報サイトです。掲載している作品情報、動画配信サービス（VOD）の配信状況・無料体験特典等は予告なく変更される場合があります。契約・ご登録の際は必ず各サービス公式サイト（DMM TV、U-NEXT、dアニメストア等）にて最新の利用規約および配信状況をご確認ください。当サイトの利用により生じた損害やトラブルについて、当サイト管理者は一切の責任を負いかねますのであらかじめご了承ください。",
    },
  },
  en: {
    ...
    footer: {
      ...
      copyrightText: "All anime artwork, logos, titles, and character images used on this site belong to their respective copyright holders and production companies.",
      affiliateTitle: "Affiliate & Streaming Partners",
      affiliateText: "This site participates in affiliate programs for streaming services like DMM TV, U-NEXT, and dAnime Store.",
      verifiedBadge: "Encrypted Connection & Official API Linked",
      copy: "© 2026 AI Anime Match. All rights reserved.",
      disclaimer: "[Disclaimer] All anime information and streaming references are provided for informational and recommendation purposes. Streaming availability, free trials, and pricing on third-party platforms are subject to change. Please verify terms on official platforms before subscribing. We assume no liability for loss or damages resulting from the use of this site.",
    },
  },
};

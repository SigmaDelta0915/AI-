...
export const UI_TRANSLATIONS = {
  ja: {
    ...
    home: {
      badge: "Gemini AI 搭載 精密アニメ診断",
      heroTitle: "あなたが見るべき最高のアニメ導き出す",
      heroSubtitle: "AIがあなたの感性を精密分析",
      heroDesc: "15問の直感的な心理テストで、最新のGemini AIとAniListデータベースがあなたの潜在的な好みと作品をマッチング。",
      startDiagnosisBtn: "無料のAI診断を始める（約1分）",
      browseCatalog: "作品カタログを見る",
      searchPlaceholder: "作品名・キーワードで検索...",
      browseGenresTitle: "ジャンルから検索",
      browseGenresSub: "お好みのカテゴリーやテーマから作品を探せます",
      trendingTitle: "今話題のアニメ",
      trendingSub: "現在人気沸騰中の話題作・評価の高い名作一覧",
      viewAllBtn: "すべての作品を見る",
    ...
    footer: {
      brandDesc: "最新のGemini AIとAniListデータベースを融合させたAIアニメ診断・マッチングプラットフォームです。",
      sitemapTitle: "サイトマップ",
      copyrightTitle: "著作権・知的財産権・アニメ画像について",
      copyrightText: "当サイトに掲載・表示されているアニメのポスター画像、カバーアート、キービジュアル、キャラクター画像、作品ロゴ、ならびに作品概要等の著作権・肖像権および知的財産権は、すべて各制作会社、原作者、出版社、および公式権利所有者に帰属します。画像はAniList等の公式APIを通じ、作品の識別・紹介および適正な引用・レビュー目的のためにのみ使用しております。",
      affiliateTitle: "公式配信サービス・アフィリエイト連携",
      affiliateText: "当サイトは各種動画配信サービス（DMM TV、U-NEXT、dアニメストア等）のアフィリエイト広告プログラムに参加しており、適正な紹介リンクを掲載しています。",
      verifiedBadge: "暗号化通信対応・公式API連携",
      copy: "© 2026 AI Anime Diagnosis. All rights reserved.",
      disclaimer: "【免責事項・画像の取り扱いについて】当サイトは著作権や肖像権の侵害を目的とするものではありません。掲載しているアニメ画像および情報は個人またはAIによる作品紹介および検索性向上を目的としています。万が一、掲載画像やコンテンツに関して権利所有者様からの削除・変更等のご要請がございましたら、権利者様ご本人より管理者へご連絡ください。確認後、迅速に削除・修正等の適切な対応を行います。また、動画配信サービス（VOD）の配信状況・無料体験特典等は予告なく変更される場合がありますので、必ず各サービス公式サイトにて最新情報をご確認ください。当サイトの利用により生じた損害等について当サイトは一切の責任を負いません。",
    },
  },
  en: {
    ...
    home: {
      badge: "Gemini AI Powered Diagnosis",
      heroTitle: "Discovering the Ultimate Anime You Should Watch",
      heroSubtitle: "AI Precision Taste Analysis",
      heroDesc: "Answer 15 intuitive questions. Powered by Gemini AI & AniList database for personalized anime recommendations.",
      startDiagnosisBtn: "Start Free AI Diagnosis (~1 min)",
      browseCatalog: "Browse Anime Catalog",
      searchPlaceholder: "Search by title or keyword...",
      browseGenresTitle: "Search by Genre",
      browseGenresSub: "Browse anime titles by category or mood",
      trendingTitle: "Trending Anime",
      trendingSub: "Popular hits and top-rated masterpieces right now",
      viewAllBtn: "View All Titles",
      ...
      feat3Desc: "Compare streaming options like DMM TV, U-NEXT, Crunchyroll, and Netflix with one click.",
    ...
    footer: {
      brandDesc: "An AI-powered anime diagnosis and matching platform powered by Gemini AI and AniList live database.",
      sitemapTitle: "Navigation",
      copyrightTitle: "Copyright, Image Attribution & Intellectual Property",
      copyrightText: "All anime posters, cover artwork, key visuals, character images, logos, and synopses displayed on this site belong to their respective creators, animation studios, publishers, and copyright holders. Images are retrieved via public APIs (e.g. AniList GraphQL API) solely for identification, recommendation, and fair review purposes.",
      affiliateTitle: "Affiliate & Streaming Partners",
      affiliateText: "This site participates in official affiliate programs for streaming services like DMM TV, U-NEXT, and dAnime Store.",
      verifiedBadge: "Encrypted Connection & Official API Linked",
      copy: "© 2026 AI Anime Match. All rights reserved.",
      disclaimer: "[Disclaimer & Image Policy] This site does not intend any copyright infringement. If you are a copyright holder and wish to request removal or modification of any image or content, please contact the site administrator for immediate action. Streaming availability, free trial offers, and pricing on third-party platforms are subject to change without notice. Please verify terms directly on official streaming services before subscribing. We assume no liability for loss or damages resulting from the use of this platform.",
    },
  },
};

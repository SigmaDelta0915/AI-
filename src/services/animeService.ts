...
async function generateClientFallbackDiagnosis(categoryScores: { [key: string]: number }): Promise<DiagnosisResult> {
  ...
  const PRESETS: Record<string, CategoryConfig> = {
    depressive: {
      ...
      keyTraits: ["#鬱アニメ", "#絶望とカタルシス", "#重厚なダーク世界観", "#人間心理の暗部", "#トラウマ級の衝撃"],
      candidates: [
        { title: "魔法少女まどか☆マギカ", reason: "可愛らしいデザインからは想像もつかない衝撃の鬱展開と緻密なストーリー。観る者の心を深く揺さぶる傑作です。" },
        { title: "Re:ゼロから始める異世界生活", reason: "幾度もの死と絶望を繰り返しながら抗う圧倒的泥臭さと鬱展開。どん底から這い上がる覚悟に心が痺れます。" },
        { title: "メイドインアビス", reason: "愛らしくも残酷で美しい大穴アビスの冒険。度重なる不条理なトラウマ級鬱シチュエーションと圧倒的世界観。" },
        { title: "シュタインズ・ゲート", reason: "愛する人を救うため無限の悲劇と鬱展開を繰り返すタイムリープ劇。絶望の果てに待つカタルシスは必見です。" },
        { title: "PSYCHO-PASS サイコパス", reason: "ディストピア社会の暗部と人間の業を暴く重厚なシリアス心理サスペンス。ダークな世界観に没入できます。" },
        { title: "ぼくらの", reason: "地球を守るために命を賭して戦う少年少女たち。背負わされた重すぎる宿命と逃れられない鬱ストーリー。" },
        { title: "新世紀エヴァンゲリオン", reason: "主人公の内面的苦悩と世界の終末を描く心理描写の金字塔。鬱々とした気分に深く共鳴する不朽の名作。" },
        { title: "サイバーパンク エッジランナーズ", reason: "ナイトシティの狂気と圧倒的な喪失感。切なくも衝撃的なラストが深く心に刻まれます。" },
      ]
    },
    action: {
